...
This post is an my attempt to follow along a [Bayesian Workflow](https://arxiv.org/abs/2011.01808) by Gelman _et al_ and create examples for better understanding. While my ultimate goal is to conduct a study on infectious disease transmission using a dynamic model framed in a Bayesian framework, I use a simpler statistical model to practice. I also consulted a [blog post](https://betanalpha.github.io/assets/case_studies/principled_bayesian_workflow.html#31_Example_Workflow_Executions) by Michael Betancourt. 

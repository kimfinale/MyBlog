...
Data were downloaded using the following command: `torchvision::mnist_dataset("./data", download=T)`.
```{r}
train = readRDS("C:/Users/jonghoon.kim/Documents/myblog/data/mnist/processed/training.rds")
test = readRDS("C:/Users/jonghoon.kim/Documents/myblog/data/mnist/processed/test.rds")

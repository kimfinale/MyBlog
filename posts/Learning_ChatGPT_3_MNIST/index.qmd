...
This post is about using [convolutional neural network](https://en.wikipedia.org/wiki/Convolutional_neural_network) to recognize hand-written digits, [MNIST](https://en.wikipedia.org/wiki/MNIST_database) data set. The following contents were adapted based on  [this](https://jtr13.github.io/cc21fall2/tutorial-on-r-torch-package.html) and 

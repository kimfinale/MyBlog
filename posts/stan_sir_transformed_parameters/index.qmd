...
I developed a SIR model and solved it an Euler method and generated a fake data as a sequence of noisy observation of daily incidence. 

simulate the data and fit the model to the data using Bayesian HMC in Stan. I used  to solve the 

#### Simulate the data

Generate $y_{1:N}$ as a sequence of noisy observations of a daily incidence.
...
mod <- stan_model(model_code=stan_code_data, verbose=TRUE)
...
data <- list(N=N,
  S0=S0, I0=I0, R0=0, CI0=0, iter_per_day=1L,
  phi=5000, beta=0.3, gamma=0.2, dt=1)
...
model {
  ...
  y ~ neg_binomial_2(daily_inf + 1e-12, phi);
...
data <- list(N=length(y), y=y, S0=S0, I0=I0, R0=0, CI0=0, iter_per_day=1L, phi=50, r=0.1, dt=1)

...
Generate infection times based on the SIR model in which $R_t$ varies
First define Rt, which is the same as used in [the prior study](https://www.sciencedirect.com/science/article/pii/S2468042723000799)
...
$$\frac{I_t-I_{t-1}}{I_{t-1}}\equiv r_t = \gamma(R_t-1) + \epsilon_i$$
$$R_t = R_{t-1} + \eta_i$$

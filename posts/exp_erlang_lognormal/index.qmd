...
There is a slight mismatch for the 95th percentile (4.3 vs 4.4 [reporeted]). This is, however, possible considering that the estimates are from Bayesian posterior samples and I can't account for the possible correlation between the parameter estimates 

Using this log-normal distribution, I generate samples ($n=1000$), to which I fit exponential and Erlang distributions.
```{r}
...
By examining $5th$ and $95th$ percentiles, we realize that the best-fit exponential distribution is too wide compared with the log-normal distribution whereas the Gamma distribution looks better. 

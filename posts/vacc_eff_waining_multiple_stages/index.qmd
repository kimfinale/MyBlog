...
Function to measure vaccine effectiveness over time points.
...
Define sum of squared difference (ssq) betwen the model and the data to evaluate the performance of the model.

...
date_start <- gsub("-", "/", Sys.Date()-7)
date_end <- gsub("-", "/", Sys.Date())
...
4. Call ChatGPT to summarize the abstract in 1-2 sentences 
This is a subscription-based service. 
You must have a ChatGPT API key and must have signed up for their paid service.

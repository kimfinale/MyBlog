...
search_results <- entrez_search(db="pubmed", term=query) # any other useful parameters?
...
get_completion <- function(prompt, model="gpt-4o", temperature=0){
  response <- httr::POST(
    ...
    httr::add_headers(Authorization = paste("Bearer", chatgpt_api_token)),
...
get_completion(promp="The cat sat on the", model="gpt-4o")
```
